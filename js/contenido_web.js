		    ...
		    if (tecla==13){
				...
				success: function(data) {
					...
					var myhtml= "";
						...
						myhtml += "<li class='portfolio-item apps'> <div class='item-inner'> <div class='portfolio-image'>";
						if (data[i].foto!=""){
							myhtml += "<img src='images/juegos/thumb/"+data[i].foto+"' alt=''>";
						}else{
							myhtml += "<img src='images/juegos/thumb/juego.png' alt=''>";
						}
						myhtml += " <div class='overlay'> <a class='preview btn btn-danger' onclick='juegos("+data[i].id_juego+");'><i class='icon-eye-open'></i></a> </div> </div>";
						myhtml += data[i].usuario+"</div></li>";

						}
				}else{
					myhtml="No hay datos a mostrar";
				}
					//alert(myhtml);
					$('#carga_contenido').html(myhtml);
				}
				});
		    }
		}
