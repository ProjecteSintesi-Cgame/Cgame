                        ...
                        <div class="form-bottom">
							<form class="login-form" method="POST" action="contenido/login.proc.php">
								...
								<div class="form-group">
		                        	...
		                        	<input type="text" name="correo" placeholder="Email..." class="form-username form-control">
		                        </div>
								<div class="form-group">
		                        	<label class="sr-only" for="form-password">Password</label>
		                        	<input type="password" name="contrasena" placeholder="Contraseña..." class="form-password form-control">
		                        </div>
